...
const COUNTRIES = [
  ...
  { name: 'Moçambique',  code: 'MZ', continent: 'África',   sub: 'Infraestrutura e construção civil',    x: 56,   y: 60  },
  ...
  { name: 'Portugal',    code: 'PT', continent: 'Europa',   sub: 'Representação e parcerias europeias',  x: 45,   y: 35,  labelLeft: true },
