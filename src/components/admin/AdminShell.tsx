...
const NAV = [
  ...
  { href: '/admin/conselho',      label: 'Conselho',       icon: '👔' },
  { href: '/admin/historia',          label: 'História',           icon: '📅' },
  { href: '/admin/sustentabilidade',  label: 'Sustentabilidade',   icon: '🌿' },
  { href: '/admin/manifesto',         label: 'Manifesto',          icon: '📜' },
  { href: '/admin/para-onde-vamos',   label: 'Para Onde Vamos',    icon: '🔮' },
  { href: '/admin/construimos-futuro',label: 'Construímos Futuro', icon: '🏗' },
  { href: '/admin/testemunhos',       label: 'Testemunhos',        icon: '💬' },
  { href: '/admin/fazemos-acontecer', label: 'Fazemos Acontecer',  icon: '📊' },
  { href: '/admin/o-que-produzimos',  label: 'O Que Produzimos',   icon: '🏭' },
  { href: '/admin/areas-negocio',     label: 'Áreas de Negócio',   icon: '🏢' },
